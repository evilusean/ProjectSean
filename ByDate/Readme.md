...
- **Workout Tracking**
  - 108+ pre-configured exercises across 9 categories
...
- **Workout Mode**
  - Pre-defined workout routines stored in Google Sheets
  - Create custom workouts with multiple exercises
  - Sets tracking with visual completion feedback (✓ indicators)
  - Automatic exercise cycling through workout routine
  - Exercise picker modal with category filtering
  - Select exercises from your Exercises sheet by category
  - Add exercises to workouts permanently or log once
  - Workout-specific exercise dropdown (only shows exercises in current workout)
  - Default workouts: Legs+Arms, Back+Pull, Chest+Core, Seated Isometric

- **Google Sheets Integration**
  - Secure OAuth authentication with Google Identity Services
  - Session persistence with automatic token refresh (50-minute intervals)
  - Adblocker detection notice for sign-in
  ...
  - Separate "Exercises" sheet with category markers (`# === CATEGORY ===`)
  - Separate "Workouts" sheet for routine management
...
- **Multiple Independent Timers**
  ...
  - Workout timer integrated into collapsible workout section
...
- **User Experience**
  ...
  - Workout mode toggle with simplified UI
  - Visual feedback for completed sets in workout mode
  - Smart dropdown management (resets after modal interactions)

Perfect for fitness enthusiasts and students seeking integrated workout and study tracking with powerful timer functionality, pre-defined workout routines, and automatic Google Sheets organization.
...
## October2025 - Algebra 1 - https://github.com/evilusean/Khan/tree/main/Algebra :
Real numbers & properties → expressions (simplifying, evaluating) → solving one-variable linear equations & inequalities → literal equations & formulas → word problems (distance, percent, mixture, age, consecutive integers) → intro to functions (domain/range, function vs. not) → graphing lines (table, intercepts, slope formula, slope-intercept form, standard form, horizontal/vertical lines) → writing equations of lines (point-slope, parallel/perpendicular) → linear inequalities & absolute value equations/inequalities → systems of linear equations (graphing, substitution, elimination) → exponent rules (positive/negative/zero exponents, power rules) → scientific notation → polynomials (classify, add, subtract, multiply monomial × polynomial & binomial × binomial, FOIL, special products) → factoring (GCF, 4-term grouping, trinomials a=1, difference of squares, perfect square trinomials) → simplifying rational expressions (cancel common factors) → intro to quadratics (factoring x² + bx + c, solving by factoring & square roots, graphing parabolas from vertex form) → basic radical simplification & operations → statistics basics (mean, median, line of best fit).
...
| [Timestamp Microservice](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-BackendAPI-Cert-Node-Express-MongoDB-Mongoose/Project1-TimeStampMicroService) | Developed an API endpoint that parses and returns timestamp data based on user input. |
| [Request Header Parser Microservice](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-BackendAPI-Cert-Node-Express-MongoDB-Mongoose/Project2-RequestHeaderParser) | Created a microservice to analyze and return information from HTTP request headers. |
| [URL Shortener Microservice](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-BackendAPI-Cert-Node-Express-MongoDB-Mongoose/Project3-URL-Shortener) | Implemented a service to shorten URLs and redirect to the original links. |
| [Exercise Tracker](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-BackendAPI-Cert-Node-Express-MongoDB-Mongoose/Project4-ExerciseTracker) | Built an API to track user exercise logs, including descriptions, durations, and dates. |
| [File Metadata Microservice](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-BackendAPI-Cert-Node-Express-MongoDB-Mongoose/Project5-FileMetaDataMicroService) | Developed a microservice to upload files and return their metadata, such as name, type, and size. |
...
Use pgAdmin and PostgreSQL to practice queries using a real large dataset simulating a video store with customer/payments/stock relational databases
...
| [Learn Bash by Building a Boilerplate](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-SQL-JS-Node-RelationalDatabases-Certificate/LearnBashByBuildingABoilerplate) | Tutorial project creating website boilerplate using bash scripting |
| [Learn Relational Databases by Building a Mario Database](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-SQL-JS-Node-RelationalDatabases-Certificate/LearnRelationalDatabasesByBuildingAMarioDatabase) | Introduction to relational databases concepts using a Mario-themed PostgreSQL database |
| [Learn Bash Scripting by Building Five Programs](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-SQL-JS-Node-RelationalDatabases-Certificate/LearnBashScriptingByBuildingFivePrograms) | Collection of five bash scripts demonstrating different scripting concepts |
| [Learn SQL by Building a Student Database: Part 1](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-SQL-JS-Node-RelationalDatabases-Certificate/LearnSQLByBuildingAStudentDatabasePart1) | First part of building a student database, covering basic SQL concepts |
| [Learn SQL by Building a Student Database: Part 2](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-SQL-JS-Node-RelationalDatabases-Certificate/LearnSQLByBuildingAStudentDatabasePart2) | Advanced SQL concepts continuing the student database project |
| [Learn Advanced Bash by Building a Kitty Ipsum Translator](https://github.com/evilusean/CourseraGoogleFCC/tree/main/FCC-SQL-JS-Node-RelationalDatabases-Certificate/LearnAdvancedBashByBuildingAKittyIpsumTranslator) | Advanced bash scripting project creating a text translator |
...
| Program Name                                                                 | Summary                                      |
|-------------------------------------------------------------------------------|----------------------------------------------|
| [Blastoff.py](https://github.com/evilusean/Python4Everyone/blob/main/Blastoff.py) | A simple countdown program.                  |
| [CountingLinesInAFileLoop.py](https://github.com/evilusean/Python4Everyone/blob/main/CountingLinesInAFileLoop.py) | Counts lines in a file using a loop.        |
| [CountingWithGet().py](https://github.com/evilusean/Python4Everyone/blob/main/CountingWithGet%28%29.py) | Counts items using a GET request.           |
| [DefiniteLoopStrings.py](https://github.com/evilusean/Python4Everyone/blob/main/DefiniteLoopStrings.py) | Loops through a list of strings.            |
| [DictionaryTop10Words.py](https://github.com/evilusean/Python4Everyone/blob/main/DictionaryTop10Words.py) | Finds the top 10 words in a dictionary.     |
| [FileLetterCount.py](https://github.com/evilusean/Python4Everyone/blob/main/FileLetterCount.py) | Counts letters in a file.                    |
| [ForBlastoffLoop.py](https://github.com/evilusean/Python4Everyone/blob/main/ForBlastoffLoop.py) | A countdown using a for loop.                |
| [FullDictionaryMultiMethodst.py](https://github.com/evilusean/Python4Everyone/blob/main/FullDictionaryMultiMethodst.py) | Multi-method operations on a dictionary.     |
| [FullDictionaryWordSearch.py](https://github.com/evilusean/Python4Everyone/blob/main/FullDictionaryWordSearch.py) | Searches for words in a dictionary.          |
| [HTTPRequest.py](https://github.com/evilusean/Python4Everyone/blob/main/HTTPRequest.py) | Makes HTTP requests.                         |
| [IndeterminateLoopBanana.py](https://github.com/evilusean/Python4Everyone/blob/main/IndeterminateLoopBanana.py) | An indeterminate loop example.               |
| [LanguageGreetingFunction.py](https://github.com/evilusean/Python4Everyone/blob/main/LanguageGreetingFunction.py) | Greets users in different languages.         |
| [LargestNumberLoop.py](https://github.com/evilusean/Python4Everyone/blob/main/LargestNumberLoop.py) | Finds the largest number in a loop.          |
| [LoopSumming.py](https://github.com/evilusean/Python4Everyone/blob/main/LoopSumming.py) | Sums numbers in a loop.                      |
| [Ooples and Boonoonoos.py](https://github.com/evilusean/Python4Everyone/blob/main/Ooples%20and%20Boonoonoos.py) | A fun program involving Ooples and Boonoonoos. |
| [OpenFileMostCommonWord.py](https://github.com/evilusean/Python4Everyone/blob/main/OpenFileMostCommonWord.py) | Finds the most common word in a file.       |
| [RegularExpressionFindAll.py](https://github.com/evilusean/Python4Everyone/blob/main/RegularExpressionFindAll.py) | Uses regex to find all matches in a string. |
| [SampleTryExcept.py](https://github.com/evilusean/Python4Everyone/blob/main/SampleTryExcept.py) | Demonstrates try-except error handling.      |
| [SearchUseingBooleanValue.py](https://github.com/evilusean/Python4Everyone/blob/main/SearchUseingBooleanValue.py) | Searches using boolean values.                |
| [SmallestNumberLoopNone.py](https://github.com/evilusean/Python4Everyone/blob/main/SmallestNumberLoopNone.py) | Finds the smallest number in a loop.         |
| [StartsWithSearch.py](https://github.com/evilusean/Python4Everyone/blob/main/StartsWithSearch.py) | Searches for strings that start with a given prefix. |
| [StringParsingFind().py](https://github.com/evilusean/Python4Everyone/blob/main/StringParsingFind%28%29.py) | Parses strings to find specific patterns.    |
| [TuplesSorting.py](https://github.com/evilusean/Python4Everyone/blob/main/TuplesSorting.py) | Sorts tuples in a list.                      |
| [URL words.py](https://github.com/evilusean/Python4Everyone/blob/main/URL%20words.py) | Processes words from a URL.                  |
| [WebScraping.py](https://github.com/evilusean/Python4Everyone/blob/main/WebScraping.py) | Scrapes data from websites.                   |
| [bible.txt](https://github.com/evilusean/Python4Everyone/blob/main/bible.txt) | Contains text from the Bible.                 |
| [bible.txt.py](https://github.com/evilusean/Python4Everyone/blob/main/bible.txt.py) | Python script related to the Bible text.     |
